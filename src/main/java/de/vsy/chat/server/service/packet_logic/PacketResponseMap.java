...
import static de.vsy.chat.shared_transmission.packet.property.communicator.EligibleCommunicationEntity.CLIENT;
import static de.vsy.chat.shared_transmission.packet.property.communicator.EligibleCommunicationEntity.SERVER;

/**
 * Can take one serverbound and one clientbound Packetto be dispatched from one
 * process.
 */
public
class PacketResponseMap {
     ...
     */
    public
    PacketResponseMap (final Packet updatePacket, final Packet clientResponse) {
     ...
     */
    private
    void setFreshMap (final Packet updatePacket, final Packet clientResponse) {
     ...
     */
    public
    boolean setClientBoundPacket (final Packet clientBound) {
     ...
     */
    private
    boolean setPacket (final EligibleCommunicationEntity direction,
                       final Packet toList) {
     ...
     */
    public
    boolean setServerBoundPacket (final Packet serverBound) {
