...
public
class CommunicationNetworkSubscriptionManager {
     ...
     */
    public
    CommunicationNetworkSubscriptionManager (
     ...
     */
    public
    boolean addCommunicationNetwork (final EligibleCommunicationEntity entity,
                                     final AbstractPacketCategorySubscriptionManager subscriptionManager) {

        try {
            this.lock.writeLock().lock();

            return this.communicationNetworks.putIfAbsent(entity,
                                                          subscriptionManager) ==
                   null;
        } finally {
     ...
     */
    public
    AbstractPacketCategorySubscriptionManager getSubscriptionsManager (
     ...
     */
    public
    boolean removeCommunicationNetwork (final EligibleCommunicationEntity entity) {
