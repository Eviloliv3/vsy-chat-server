...
class ServiceData {
     ...
     */
    private
    ServiceData (final ServiceDataBuilder dataBuilder) {
    ...
    class ServiceDataBuilder {
         ...
         */
        public
        ServiceDataBuilder withDirection (final ServiceResponseDirection direction,
            ...
            if (this.responseDirections == null) {
                this.responseDirections = new EnumMap<>(
                        ServiceResponseDirection.class);
            }
         ...
         */
        public
        ServiceDataBuilder withName (final String baseName) {
         ...
         */
        public
        ServiceDataBuilder withType (final Service.TYPE serviceType) {
    ...
    public
    Map<ServiceResponseDirection, Service.TYPE> getResponseDirections () {
