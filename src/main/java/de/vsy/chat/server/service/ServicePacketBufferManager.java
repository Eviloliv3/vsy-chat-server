...
public
class ServicePacketBufferManager {
    ...
    public
    ServicePacketBufferManager (
            final Map<Service.TYPE, Map<Integer, PacketBuffer>> bufferMap) {
     ...
     */
    public
    boolean deregisterBuffer (final Service.TYPE serviceType, final int bufferLabel,
     ...
     */
    public
    PacketBuffer getRandomBuffer (final Service.TYPE serviceType) {
        ...
        try {
            ...
            if (bufferList != null && !bufferList.isEmpty()) {
                buffer = bufferList.get(
                        RANDOM_NUMBER_GENERATOR.nextInt(bufferList.size()));
            }
        } finally {
     ...
     */
    public
    List<PacketBuffer> getAllBuffersFor (final Service.TYPE serviceType) {
        Map<Integer, PacketBuffer> bufferMap;
     ...
     */
    public
    PacketBuffer getSpecificBuffer (final Service.TYPE serviceType,
                                    final int bufferLabel) {
        PacketBuffer buffer = null;
        Map<Integer, PacketBuffer> bufferMap;
