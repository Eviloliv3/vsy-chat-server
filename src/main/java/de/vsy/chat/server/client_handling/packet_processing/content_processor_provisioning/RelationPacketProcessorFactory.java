...
import de.vsy.chat.shared_module.packet_validation.content_validation.relation.ContactRelationRequestValidator;
import de.vsy.chat.shared_module.packet_validation.content_validation.relation.ContactRelationResponseValidator;
...
import de.vsy.chat.server.client_handling.packet_processing.content_processing.RelationRequestProcessor;
import de.vsy.chat.server.client_handling.packet_processing.content_processing.RelationResponseProcessor;
import de.vsy.chat.shared_transmission.packet.content.PacketContent;
import de.vsy.chat.shared_transmission.packet.content.relation.RelationContent;

public
class RelationPacketProcessorFactory implements ContentBasedProcessorFactory {

    private final HandlerLocalDataManager threadDataAccess;

    public
    RelationPacketProcessorFactory (HandlerLocalDataManager threadDataAccess) {
