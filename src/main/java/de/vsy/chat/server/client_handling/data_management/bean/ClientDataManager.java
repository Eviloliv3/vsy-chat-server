...
import static de.vsy.chat.server.persistent_data.EmptyDataProvider.EMPTY_COMMUNICATOR_DATA;

public
class ClientDataManager implements LocalClientDataProvider {
    ...
    public final
    void setCommunicatorData (CommunicatorData newClientData) {
        this.clientData =
                newClientData != null ? newClientData : EMPTY_COMMUNICATOR_DATA;
