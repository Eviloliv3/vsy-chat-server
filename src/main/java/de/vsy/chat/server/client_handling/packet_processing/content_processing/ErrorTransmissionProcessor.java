...
import de.vsy.chat.server.client_handling.data_management.access_limiter.ErrorHandlingDataProvider;
...
public
class ErrorTransmissionProcessor implements ContentProcessor<ErrorDTO> {
    ...
    public
    ErrorTransmissionProcessor (final ErrorHandlingDataProvider threadDataAccess) {
        this.contentHandler = threadDataAccess.getResultingPacketContentHandler();
    }

    @Override
    public
    void processContent (ErrorDTO validatedContent) {
