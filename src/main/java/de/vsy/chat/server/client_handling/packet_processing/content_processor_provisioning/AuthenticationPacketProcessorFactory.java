...
import de.vsy.chat.shared_module.packet_processing.ProcessingCondition;
import de.vsy.chat.shared_module.packet_processing.ProcessingConditionType;
import de.vsy.chat.shared_module.packet_processing.processor_provision.ContentBasedProcessorFactory;
import de.vsy.chat.shared_module.packet_validation.content_validation.authentication.LoginRequestValidator;
import de.vsy.chat.shared_module.packet_validation.content_validation.authentication.LogoutRequestValidator;
import de.vsy.chat.shared_module.packet_validation.content_validation.authentication.NewAccountRequestValidator;
import de.vsy.chat.shared_module.packet_validation.content_validation.authentication.ReconnectRequestValidator;
import de.vsy.chat.server.client_handling.data_management.HandlerLocalDataManager;
import de.vsy.chat.server.client_handling.packet_processing.ClientHandlerPacketProcessor;
import de.vsy.chat.server.client_handling.packet_processing.content_processing.LoginRequestProcessor;
import de.vsy.chat.server.client_handling.packet_processing.content_processing.LogoutRequestProcessor;
import de.vsy.chat.server.client_handling.packet_processing.content_processing.NewAccountRequestProcessor;
import de.vsy.chat.server.client_handling.packet_processing.content_processing.ReconnectRequestProcessor;
import de.vsy.chat.shared_transmission.packet.content.PacketContent;

import static de.vsy.chat.shared_transmission.packet.content.authentication.AuthenticationContent.valueOf;

public
class AuthenticationPacketProcessorFactory implements ContentBasedProcessorFactory {

    private final HandlerLocalDataManager threadDataAccess;

    public
    AuthenticationPacketProcessorFactory (
            final HandlerLocalDataManager threadDataAccess) {
