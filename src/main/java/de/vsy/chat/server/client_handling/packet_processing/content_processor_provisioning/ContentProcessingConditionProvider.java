...
import de.vsy.chat.shared_module.packet_processing.HandlerProcessingCondition;
...
public
class ContentProcessingConditionProvider {

    private
    ContentProcessingConditionProvider () {
    }

    public static
    ProcessingCondition getContentProcessingCondition (
        ...
        return switch (conditionType) {
            case NOT_AUTHENTICATED -> new HandlerProcessingCondition<>(
                    Predicate.not(clientStateProvider::checkClientState),
                    ClientState.AUTHENTICATED,
                    "Anfrage nicht bearbeitet. Sie sind bereits authentifiziert.");
            case AUTHENTICATED -> new HandlerProcessingCondition<>(
                    clientStateProvider::checkClientState, ClientState.AUTHENTICATED,
