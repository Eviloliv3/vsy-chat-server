...
public
class PermittedPackets extends PermittedCategoryProvider {
     ...
     */
    public
    PermittedPackets (final List<PacketCategory> categories) {
    ...
    List<PacketCategory> getPermittedPacketCategories () {
        ...
        if (super.otherPermittedCategories != null) {
            permittedCategories.addAll(
                    super.otherPermittedCategories.getPermittedPacketCategories());
        }
