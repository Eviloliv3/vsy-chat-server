 ...
 *
 */
package de.vsy.chat.server.client_handling.data_management;
...
public
class CommunicationEntityDataProvider {
     ...
     */
    public
    CommunicationEntityDataProvider (
     ...
     *
     * @param contactList Liste von intn, zu denen Clientdaten benötigt
     *         werden.
     *
     * @return Liste von Clientdaten, vom Typ Arraylist
     */
    public
    Set<CommunicatorDTO> mapToContactData (final Set<Integer> contactList) {
    ...
    /**
     * Gibt Clientdaten eines Freundes (bestimmt durch die Identifikationsnummer)
     * aus.
     *
     ...
     */
    public
    CommunicatorData getContactData (final int contactId) {
        return this.clientData.getCommunicatorData(contactId);
    }

    /**
     * Entfernt alle Clientdaten aus einer Liste, die nicht in der Freundesliste
     * enthalten sind.
     *
     ...
     */
    public
    Set<Integer> removeOfflineContacts (final Set<Integer> activeClientIdList) {
