...
import de.vsy.chat.shared_module.packet_validation.content_validation.error.ErrorContentValidator;
...
import de.vsy.chat.server.client_handling.packet_processing.content_processing.ErrorTransmissionProcessor;
import de.vsy.chat.shared_transmission.packet.content.PacketContent;

import static de.vsy.chat.shared_transmission.packet.content.error.ErrorContent.ErrorDTO;
import static de.vsy.chat.shared_transmission.packet.content.error.ErrorContent.valueOf;
