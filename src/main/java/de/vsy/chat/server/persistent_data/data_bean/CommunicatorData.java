...
public
class CommunicatorData implements Serializable {
    ...
    public
    CommunicatorData (CommunicatorData toCopy) {
        this(toCopy.getCommunicatorId(), toCopy.getOwnerId(),
     ...
     */
    private
    CommunicatorData (final int communicatorId, final int ownerId,
     ...
     */
    public
    boolean isOwner (final int ownerId) {
    ...
    public
    String toString () {
        return "\"communicatorId\": " + this.communicatorId + ", \"ownerId\": " +
               this.ownerId + ", \"displayName\": " + this.displayName;
    }
}
