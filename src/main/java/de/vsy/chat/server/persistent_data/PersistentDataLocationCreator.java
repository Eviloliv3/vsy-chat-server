...
import static de.vsy.chat.server.persistent_data.PersistentDataLocationCreator.DataPathDescriptor.*;
import static java.io.File.separator;
import static java.lang.System.getProperty;

/** Simple tool for creating preset directories. fredward */
public
class PersistentDataLocationCreator {
    ...
    static {
        ...
        BASE_LOCATION =
                getProperty("user.home") + separator + "Dokumente" + separator +
                "VSY_Chat_Server_Daten" + separator;
    ...
    private static
    String createStandardDirectoryPath (DataOwnershipDescriptor owner,
                                        final String pathExtension) {
    ...
    private static
    String createBackUpDirectoryPath (DataOwnershipDescriptor owner,
                                      final String pathExtension) {
     ...
     */
    private static
    boolean createDirectoryPaths (final String[] dataPaths)
    throws InterruptedException {
