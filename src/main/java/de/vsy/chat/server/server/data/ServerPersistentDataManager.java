...
import de.vsy.chat.server.persistent_data.server_data.*;
...
public
class ServerPersistentDataManager {
    ...
    public
    ClientTransactionDAO getTransactionAccessManager () {
        return this.transactionAccessManager;
    }

    public
    CommunicatorPersistenceDAO getCommunicationEntityAccessManager () {
    ...
    public
    ClientAuthPersistenceDAO getClientAuthenticationAccessManager () {
