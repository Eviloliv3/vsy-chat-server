...
/**
 * Grants writing accessLimiter to the file containing a client's message
 * histories.
 */
public class MessageDAO implements ClientDataAccess {
	...
	public static JavaType getDataFormat() {
		...
		final JavaType msgListType = factory.constructCollectionType(ArrayList.class, TextMessageDTO.class);
