...
public class CommunicatorData implements Serializable {
	...
	public static CommunicatorData valueOf(@JsonProperty("communicatorId") final int communicatorId,
			@JsonProperty("ownerId") final int ownerId, @JsonProperty("displayName") final String displayName) {
	...
	public String toString() {
		return "\"communicatorId\": " + this.communicatorId + ", \"ownerId\": " + this.ownerId + ", \"displayName\": "
				+ this.displayName;
	}
}
