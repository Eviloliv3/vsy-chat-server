...
public
class AuthenticationData implements Serializable {
     ...
     */
    private
    AuthenticationData (final String login, final String password,
                        final int clientId) {
        this.login = login;
    ...
    @Override
    public
    boolean equals (final Object otherObject) {
        if (this == otherObject) {
            return true;
        }

        if (otherObject instanceof AuthenticationData otherAccount) {
            return this.clientId == otherAccount.getClientId() &&
                   this.login.equals(otherAccount.getLogin()) &&
    ...
    public
    String toString () {
        return "\"clientId\": " + this.clientId + ", \"login\": " + login +
               ", \"password\": " + password;
    }
     ...
     */
    public
    boolean sameCredentials (final AuthenticationData otherAuthData) {

        if (otherAuthData != null) {
            return sameLogin(otherAuthData) &&
                   password.equals(otherAuthData.getPassword());
        }
        return false;
    }
     ...
     * @param otherAuthData the other auth dataManagement
     *
     * @return boolean: true, if both bean contain the same login name; false
     *         otherwise
     */
    public
    boolean sameLogin (final AuthenticationData otherAuthData) {
