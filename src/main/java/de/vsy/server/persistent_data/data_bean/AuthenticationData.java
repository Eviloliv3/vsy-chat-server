...
public class AuthenticationData implements Serializable {
	...
	public static AuthenticationData valueOf(@JsonProperty("login") final String login,
			@JsonProperty("password") final String password, @JsonProperty("clientId") final int clientId) {
	...
	public boolean equals(final Object otherObject) {
		...
		if (otherObject instanceof AuthenticationData otherAccount) {
			return this.clientId == otherAccount.getClientId() && this.login.equals(otherAccount.getLogin())
	...
	public String toString() {
		return "\"clientId\": " + this.clientId + ", \"login\": " + login + ", \"password\": " + password;
	}
