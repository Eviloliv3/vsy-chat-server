...
public class PersistentDataLocationCreator {
	...
	static {
		...
		BASE_LOCATION = getProperty("user.home") + separator + "Dokumente" + separator + "VSY_Chat_Server_Daten"
				+ separator;
	 ...
	 * @return the string[]
	 */
	public static String[] createDirectoryPaths(DataOwnershipDescriptor owner, final String pathExtension)
	...
	private static String createStandardDirectoryPath(DataOwnershipDescriptor owner, final String pathExtension) {
		final var directory = createBasePath(owner, pathExtension, false);
		return finalizeDirectoryPath(directory);
	}

	private static String createBackUpDirectoryPath(DataOwnershipDescriptor owner, final String pathExtension) {
	 ...
	 */
	private static boolean createDirectoryPaths(final String[] dataPaths) throws InterruptedException {
	...
	private static StringBuilder createBasePath(final DataOwnershipDescriptor owner, final String pathExtension,
	...
	public static String createDirectoryPath(DataOwnershipDescriptor owner, final String pathExtension)
			throws InterruptedException {
