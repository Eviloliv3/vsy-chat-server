...
public
class ClientPacketDispatcher implements MultiplePacketDispatcher {
     ...
     */
    public
    ClientPacketDispatcher (final LocalClientDataProvider clientDataManager,
    ...
    @Override
    public
    void dispatchPacket (final Deque<Packet> output) {
    ...
    /**
     * Packet is client bound if: local client not authenticated; recipient is
     * STANDARD_CLIENT_ID recipientId equals clientId
     *
     ...
     */
    private
    boolean isClientBound (final int recipientId) {
