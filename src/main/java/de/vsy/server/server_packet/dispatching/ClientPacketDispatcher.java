...
public class ClientPacketDispatcher implements MultiplePacketDispatcher {
	...
	public ClientPacketDispatcher(final LocalClientDataProvider clientDataManager,
		...
		this.clientBoundBuffer = threadLocalBuffers.getPacketBuffer(ThreadPacketBufferLabel.OUTSIDE_BOUND);
		this.serverBoundBuffer = threadLocalBuffers.getPacketBuffer(ThreadPacketBufferLabel.SERVER_BOUND);
	}
