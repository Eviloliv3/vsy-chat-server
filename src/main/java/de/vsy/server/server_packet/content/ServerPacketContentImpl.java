...
/**
 * Interne Erweiterung des PacketContent, u.a. zur Feststellung von Ursprung
 * (Server) bzw. Synchronisation von Paketen.
 */
public abstract class ServerPacketContentImpl implements PacketContent, ServerStatusSync {
	...
	@JsonCreator
	protected ServerPacketContentImpl(@JsonProperty("synchronizedServers") final Set<Integer> synchronizedServers,
