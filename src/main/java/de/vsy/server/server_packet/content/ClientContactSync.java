...
/**
 * Schnittstelle zur Klientenstatussynchronisation. Synchronisationspaket soll auch
 * ein Paket zur Synchronisation von betroffenen Klienten enthalten.
 */
public
interface ClientContactSync {
