...
import static de.vsy.shared_transmission.shared_transmission.packet.property.packet_type.ChatType.GROUP_MESSAGE;
import static de.vsy.shared_transmission.shared_transmission.packet.property.packet_type.ChatType.GROUP_REGISTRATION;
...
public class ServerPacketTypeValidationCreator {
	...
	public static SemanticPacketValidator createRegularServerPacketContentValidator() {
		...
		for (var categoryValidation : regularContentValidator.entrySet()) {
			semanticValidator.addCategoryAssociations(categoryValidation.getKey(), categoryValidation.getValue());
		}
	...
	public static Map<PacketType, Set<Class<? extends PacketContent>>> setupStatusValidation() {
		...
		statusMapping.put(ServerStatusType.CLIENT_STATUS, of(BaseStatusSyncDTO.class, ExtendedStatusSyncDTO.class));
	...
	public static Map<PacketType, Set<Class<? extends PacketContent>>> setupErrorValidation() {
		...
		errorMapping.put(ServerErrorType.SERVER_STATUS, of(ServerFailureDTO.class, SimpleInternalContentWrapper.class));
