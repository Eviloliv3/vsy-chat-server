...
/**
 * Prueft ob Paketinhalt bereits vom entfernten Server verarbeitet wurde und
 * stoppt den versandt gegebenenfalls.
 */
	...
	public void appendPacket(Packet input) {
		...
		if (content instanceof final ServerPacketContentImpl serverContent) {
			...
			if (content == null) {
				...
				throw new IllegalArgumentException("Paket wird nicht gesandt. Ungesicherter Paketinhalt: " + input);
			}
		}
	}
