...
public class ServerFollowerConnectionEstablisher extends ThreadContextRunnable {
	...
	public ServerFollowerConnectionEstablisher(final ServerConnectionDataManager serverConnectionManager,
	...
	public void runWithContext() {
		...
		final var watchedSocket = this.serverConnectionManager.getServerReceptionConnectionData().getConnectionSocket();
