...
public
class RemoteFollowerServerConnectionData implements ServerConnectionDataProvider {

    private final int remoteServerId;
    private final ServerSocket masterSocket;

    private
    RemoteFollowerServerConnectionData (final int remoteServerId,
    ...
    public
    RemoteFollowerServerConnectionData valueOf (final int remoteServerId,
                                                final ServerSocket masterSocket) {
