...
public class ServerConnectionDataManager {
  ...
  public boolean addNotSynchronizedConnectionData(RemoteServerConnectionData serverConnectionData) {
    ...
    if (serverConnectionData != null && !this.notSynchronizedRemoteServers.contains(
  ...
  /**
   * Schließt alle Verbindungen. Zunächst Klientenrezeption und Serverrezeption -> es kommen keine
   * neuen Verbindungen dazu
   */
