...
public class CurrentClientState {
	...
	public CurrentClientState(@JsonProperty("currentState") final ClientState currentState,
			@JsonProperty("pendingState") final PendingState pendingState, @JsonProperty("serverId") final int serverId,
	 ...
	 */
	public void updateExtraSubscription(final PacketCategory topicName, final int threadId, final boolean toAdd) {
