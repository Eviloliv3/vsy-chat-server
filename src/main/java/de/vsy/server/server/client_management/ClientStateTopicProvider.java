 ...
 * Sender CommunicationEndpointId types. A client is not allowed to send
 * requests with a String as CommunicationEndpointId after he was labelled as
 * AUTHENTICATED. He is expected to use his clientId.
 */
public class ClientStateTopicProvider {
	...
	static {
		MESSENGER = new ClientStateTopicProvider(of(ClientState.AUTHENTICATED, ClientState.ACTIVE_MESSENGER),
	...
	private ClientStateTopicProvider(final Set<ClientState> subscriptionDependencies,
	...
	public Set<ClientState> getDependencies(final boolean isSubscription) {
