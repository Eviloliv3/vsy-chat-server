...
public class ClientSubscriptionManager extends AbstractPacketCategorySubscriptionManager {
	...
	public ClientSubscriptionManager(final Map<PacketCategory, Map<Integer, CategoryIdSubscriber>> subscriptions) {
	...
	@Override
	public boolean subscribe(final PacketCategory topic, final int threadId, final PacketBuffer bufferSuggestion) {
