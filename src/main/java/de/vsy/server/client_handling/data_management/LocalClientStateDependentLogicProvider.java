...
public class LocalClientStateDependentLogicProvider {
	...
	public LocalClientStateDependentLogicProvider(final HandlerLocalDataManager handlerDataAccess) {
		...
		this.clientSubscriptionHandler = new ClientSubscriptionHandler(extraSubscriptionProvider,
				handlerDataAccess.getLocalClientDataProvider(), handlerDataAccess.getHandlerBufferManager());
		this.clientStatePublisher = new ClientStatePublisher(handlerDataAccess.getLocalClientDataProvider(),
	...
	public ClientStatePublisher getClientStatePublisher() {
