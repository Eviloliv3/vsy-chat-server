...
public final class HandlerLocalDataManager implements AuthenticationHandlingDataProvider, StatusHandlingDataProvider,
	...
	public HandlerLocalDataManager(final PacketBuffer requestAssignmentBuffer) {
		...
		this.contentHandler = new ResultingPacketContentHandler(packetCreator, cachedPackets);
		this.stateRecorder = new ClientStateRecorder(this.clientStateManager, this.clientDataManager);
		this.contactMapper = new CommunicationEntityDataProvider(HandlerAccessManager.getClientSubscriptionManager(),
	...
	private void createThreadPacketBuffers(PacketBuffer requestAssignmentBuffer) {
		this.threadBuffers.setPacketBuffer(ThreadPacketBufferLabel.SERVER_BOUND, requestAssignmentBuffer);
	...
	@Override
	public ClientStateControl getGlobalClientStateControl() {
		return this.stateRecorder;
	}
