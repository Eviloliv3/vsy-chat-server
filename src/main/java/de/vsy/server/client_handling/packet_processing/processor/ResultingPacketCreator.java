...
public abstract class ResultingPacketCreator {
	 ...
	 *
	 * @param currentRequest the this.currentRequest, responses/results will be base
	 *                       on
	 */
	...
	public abstract Packet createRequest(PacketContent processedContent, final CommunicationEndpoint recipient);
