...
public class ClientHandlerPacketProcessor<T extends PacketContent> implements PacketProcessor {
	...
	public ClientHandlerPacketProcessor(final LocalClientDataProvider clientData, final ProcessingCondition condition,
			final PacketContentValidator<T> contentValidator, final ContentProcessor<T> contentProcessor) {
