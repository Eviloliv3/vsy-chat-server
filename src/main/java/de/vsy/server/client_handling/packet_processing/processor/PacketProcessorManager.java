...
public class PacketProcessorManager {
	...
	public Optional<PacketProcessor> getProcessor(ContentIdentifier identifier,
		...
		categoryProcessing = contentHandlerProvider.getProcessor(identifier.getPacketCategory(), contentType);
		...
		if (categoryProcessing.isEmpty()) {
			...
			this.contentHandlerProvider.registerTypeProcessingProvider(identifier.getPacketCategory(), factory);
