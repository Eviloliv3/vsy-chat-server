...
public class RelationRequestProcessor implements ContentProcessor<ContactRelationRequestDTO> {
	...
	@Override
	public void processContent(final ContactRelationRequestDTO extractedContent) throws PacketProcessingException {
	 ...
	 */
	private void checkRequestLegitimacy(final ContactRelationRequestDTO contactRequest, final int contactId)
			throws PacketProcessingException {
		final var desiredState = contactRequest.getDesiredState();
		final var contactsAlready = this.contactProvider.checkAcquaintance(contactRequest.getContactType(), contactId);
