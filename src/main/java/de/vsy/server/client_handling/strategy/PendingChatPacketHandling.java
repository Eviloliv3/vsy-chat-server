 ...
 */
public class PendingChatPacketHandling implements PacketHandlingStrategy {
   ...
   */
  public PendingChatPacketHandling(final HandlerLocalDataManager threadDataAccess) {
