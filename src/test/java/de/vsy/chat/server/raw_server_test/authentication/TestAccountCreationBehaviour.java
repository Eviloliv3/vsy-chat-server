...
public class TestAccountCreationBehaviour extends ServerTestBase {
	...
	void newAccountSuccess() {
		...
		accountCreationBuilder.withAuthenticationData(AuthenticationDTO.valueOf("Peter" + randomAppendix, "login"))
	...
	void newAccountFailMalformedData() {
		...
		accountCreationBuilder.withAuthenticationData(AuthenticationDTO.valueOf("123456", STANDARD_EMPTY_STRING))
