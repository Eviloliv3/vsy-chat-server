...
public class TestAccountCreationBehaviour extends ServerTestBase {
    ...
    void newAccountSuccess() {
        ...
        final var credentials = AuthenticationDTO.valueOf("peter" + randomAppendix, "login");
        final var personalInformation = PersonalData.valueOf("randomPeter" + randomAppendix, "random");
        accountCreationBuilder.withAuthenticationData(credentials)
                .withPersonalData(personalInformation);
