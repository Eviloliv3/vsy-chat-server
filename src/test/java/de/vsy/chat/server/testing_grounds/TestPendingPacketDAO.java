...
public class TestPendingPacketDAO {
	 ...
	 * ContactMessengerStatusDTO(EligibleContactEntity.CLIENT, true, commDTO,
			...
			public void run() {
				...
				try {
					path = PersistentDataLocationCreator
							.createDirectoryPath(PersistentDataLocationCreator.DataOwnershipDescriptor.SERVER, "test");
