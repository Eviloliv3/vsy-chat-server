...
class TestServerStatusBuilder {
  ...
  @Test
  public void createSimpleInternalContent() {
    var builder = new SimpleStatusSyncBuilder<>();
    var content = builder.withContactData(valueOf(STANDARD_CLIENT_ID, "testtest"))
        .withClientState(ClientState.AUTHENTICATED).build();
  }
}
