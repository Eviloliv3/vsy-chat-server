...
import de.vsy.chat.server.persistent_data.client_data.ClientDataAccess;
...
public
class PacketSaver implements ClientDataAccess {
    ...
    PacketSaver () {
        ...
        persistance = new PersistenceDAO(DataFileDescriptor.PENDING_PACKETS,
                                         getType());
    }
    ...
    public
    void savePacket (Packet toWrite) {
        try {
    ...
    @Override
    public
    void createFileAccess (int clientId)
