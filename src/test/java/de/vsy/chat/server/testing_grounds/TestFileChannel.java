...
class TestFileChannel {
    ...
    throws IOException {
        ...
        /*try {
            file2 = new RandomAccessFile("/home/fredward/Dokumente/VSY_Chat_Server_Daten/data/clientTransactionsUTF_8.json","rw");
            channel2 = file2.getChannel();
            lock2 = channel2.lock(0L, Long.MAX_VALUE, true);
            Assertions.assertTrue(lock2.isValid());
            channel2.close();
            file2.close();
        }catch(IOException ioe){
            ioe.printStackTrace();
